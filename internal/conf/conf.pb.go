...
type Jwt struct {
	...
	ExpiresIn     int64                  `protobuf:"varint,3,opt,name=expires_in,json=expiresIn,proto3" json:"expires_in,omitempty"` // 过期时间(seconds)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_conf_proto_rawDesc = "" +
	...
	"\x04Auth\x12!\n" +
	"\x03jwt\x18\x01 \x01(\v2\x0f.kratos.api.JwtR\x03jwt\"]\n" +
	"\x03Jwt\x12\x1f\n" +
	"\x06secret\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x06secret\x12\x16\n" +
	"\x06issuer\x18\x02 \x01(\tR\x06issuer\x12\x1d\n" +
	"\n" +
	"expires_in\x18\x03 \x01(\x03R\texpiresInB\x1cZ\x1aaccount/internal/conf;confb\x06proto3"
...
var file_conf_proto_depIdxs = []int32{
	...
	4,  // 7: kratos.api.Auth.jwt:type_name -> kratos.api.Jwt
