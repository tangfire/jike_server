...
func NewHTTPServer(c *conf.Server, account *service.AccountService, article *service.ArticleService, jobService *service.JobService, jwt *auth.JWT, logger log.Logger) *http.Server {
	// 启动定时任务
	jobService.Start()
	// 配置 JSON 编码器
